...
VERSION2SPECS = {
    "SDXL-base-1.0": {
        ...
        "ckpt": "checkpoints/stable-diffusion-xl-base-1.0/sd_xl_base_1.0.safetensors",
    },
    "SDXL-base-0.9": {
        "H": 1024,
        "W": 1024,
    ...
    "SDXL-refiner-1.0": {
        ...
        "is_legacy": True,
        "config": "configs/inference/sd_xl_refiner.yaml",
        "ckpt": "checkpoints/stable-diffusion-xl-refiner-1.0/sd_xl_refiner_1.0.safetensors",
    },
}
...
def apply_refiner(
    ...
    return samples, start_time_refine
...
if __name__ == "__main__":
    ...
    if mode == "txt2img":
        out, start_time_txt2img = run_txt2img(
            state,
            version,
            version_dict,
            is_legacy=is_legacy,
        ...
        duration_txt2img = time.time() -start_time_txt2img
    elif mode == "img2img":
        out, start_time_img2img = run_img2img(
            state,
            version_dict,
            is_legacy=is_legacy,
            return_latents=add_pipeline,
    ...
    duration_txt2img_with_refine = time.time() - start_time_txt2img
    
    print(f'\nduration_txt2img {round(duration_txt2img, 2)}s')
    print(f'duration_txt2img_with_refine {round(duration_txt2img_with_refine, 2)}s')
